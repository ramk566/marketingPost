...
//
//    @Override
//    public ApiResponse<MarketingPost> generateMarketingPostsPrompt(RequestDto requestDto) {
//        try {
...
//
//            List<MarketingPost> prompts = parsePostResponse(response);
...
//                    marketingPosts.add(new MarketingPost(no, postContent));
//                }
//            }
