...
//
//@Service
//public class PostImageCode implements MarketingPostGeminiService {
//
...
//    private static final String RUNWARE_API_KEY = "lCDzXj2n8WYfgeYfhaV3CNkbgdeMdyUc";
//
//    @Override
...
//                    return results.get(0).path("imageURL").asText();
//                }
//            }
//        } catch (Exception e) {
